 ...
 */
function calculateExamTotalMax(courseOutcomes, isInternal) {
 ...
 */
function distributeTotalMarksToCos({ totalMarks, courseOutcomes, isInternal, decimals = 2 }) {
...
module.exports = {
  calculateExamTotalMax,
  distributeTotalMarksToCos,
};
